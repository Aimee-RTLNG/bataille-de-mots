...
<template>
	...
	<div id="board-wrapper">
		<div id="board">
			<div v-if="message" :class="['board-message', 'backdrop-blur', success && 'board-message-success']">
				<button v-if="success" @click="message = ''"
					class="absolute right-6 top-3 text-gray-300 hover:text-gray-100 focus:text-gray-100 w-8 h-8 flex items-center justify-center -mr-3 rounded-full">
					<span class="sr-only">Fermer</span>
					<svg class="w-6 h-6" width="16" height="16" viewBox="0 0 16 16" fill="currentColor"
	...
	<div class="board-others">
		<slot name="board-others" />
	</div>
</template>
